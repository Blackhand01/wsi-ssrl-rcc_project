...
# get image path
main_histo_data = r'D:\Doctoral_Programs\RCC\orignal_data\pre'
case_folder = os.path.join(main_histo_data,'ccRCC') # 18 19 23 24 5 6 7
...
# paths to openslide executables
    opslide_show_props_exe = r'C:/openslide-win64-20171122/bin/openslide-show-properties.exe'
    opslide_write_png_exe = r'C:/openslide-win64-20171122/bin/openslide-write-png.exe'
...
## Extract Level n
    ...
    out_file = os.path.join(case_folder,f+'.png') # change according to desired output folder
